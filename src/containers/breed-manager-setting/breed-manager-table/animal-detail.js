...
import clientPetBreedListConfig from '@lib/constants/list-configs/pet/breed-manager-setting/client-pet-breed'
    ...
    <Modal
      ...
      <Modal.Content>
        ...
        <div className='table-row-padding'>
          <Table config={clientPetBreedListConfig} duck={ClientPetBreedDuck}/>
        </div>
        <ModalDelete
