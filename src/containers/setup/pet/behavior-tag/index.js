                ...
                <Segment className='general-tag-segment'>

                  {
                    tag.length > 0 && tag.map((_item,_index)=>{
                      let searched = searchState.length > 0 && searchState.includes(_item.title) ? true : false
                ...
                <Segment className='general-tag-segment'>

                  {
                    daycamp.length > 0 && daycamp.map((_item,_index)=>{
                      let searched = searchState.length > 0
                   && searchState.includes(_item.title) ? true : false
