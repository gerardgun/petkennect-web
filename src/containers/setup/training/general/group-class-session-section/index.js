...
import serviceListConfig from '@lib/constants/list-configs/service/training-group-class-session'

import serviceDuck from '@reducers/service'
import serviceDetailDuck from '@reducers/service/detail'

const SetupTrainingGeneralGroupClassSessionIndex = () => {
...
export default SetupTrainingGeneralGroupClassSessionIndex
