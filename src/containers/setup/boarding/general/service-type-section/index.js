...
import boardingServiceTypeListConfig from '@lib/constants/list-configs/service/boarding-service-type'

import serviceDuck from '@reducers/service'
import serviceDetailDuck from '@reducers/service/detail'

const SetupBoardingGeneralServiceTypeIndex = () => {
  ...
  return (
    <Layout>
      <Segment className='segment-content' padded='very'>
        ...
        <Tab>
          <Table
            config={boardingServiceTypeListConfig}
            duck={serviceDuck}
...
export default SetupBoardingGeneralServiceTypeIndex
