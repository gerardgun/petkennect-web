...
function TabClientInfo({ clientDetail  }) {
  return (
    <Tab.Pane className='border-none'>
      ...
      <Header as='h6' className='section-header mt36' color='blue'>CONTACT DETAILS</Header>
      <div className='flex flex-row align-center mv20'>
        <InputReadOnly
          className='w33'
          label='Cell Phone'
      ...
      <Header as='h6' className='section-header mt36' color='blue'>CLIENT ADDRESS</Header>
      <div className='flex flex-row align-center mv20'>
        <InputReadOnly
          className='w100'
          label='Address 1'
