...
import ProductCreateForm from './index'

import productDetailDuck from '@reducers/product/detail'

const ProductCreateFormModal = () => {
  ...
  return (
    <Modal
      ...
      size='small'>
      <Modal.Content>
        <Header as='h2'>{editing ? 'Update' : 'New'} Product</Header>
        ...
        <Form.Group className='form-modal-actions' widths='equal'>
          <Form.Field>
            ...
            <Button
              color='teal'
              content={editing ? 'Save changes' : 'Create Product'}
              disabled={saving}
              form='product'
              loading={saving}
              type='submit'/>
...
export default ProductCreateFormModal
