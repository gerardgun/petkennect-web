...
function* get(/* { payload } */) {
  try {
    ...
    yield put({
      ...
      payload: {
        items: [ { id: 0, reserved: '03/16/2021', location_code: 'S Stadium',night: '10', type: 'Single', addons: '$ 40.00', check_in_date: '06/16/2021', checkout_at: '06/26/2021' },
          { id: 1, reserved: '03/18/2021', location_code: 'S Stadium', night: '4',type: 'Single', addons: 'Add', check_in_date: '03/16/2021', checkout_at: '03/20/2021' },
          { id: 2, reserved: '03/21/2021', location_code: 'R University',night: '6', type: 'Shared', addons: '$ 80.00',check_in_date: '04/01/2021', checkout_at: '01/07/2021'  }
